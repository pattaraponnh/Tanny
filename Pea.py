...
settings = {
    ...
    "message":"บัญชีนี้ถูกป้องกันโดย แมวแทนไร้สังกัด  ระบบได้ทำการบล็อคคุณอัตโนมัติ!..",
    "comment":"""""",
    "userAgent": [
...
#==============================================================================#
                    ...
                    line.sendMessage(to, " Bot Self ออน\n {}".format(str(runtime)))
...
#===========
                    ...
                    line.sendMessage(to,"🔱แมวแทน BotSelf ยังอยู่ครับ🔱")       
#==============================================================================#
...
#===========
                    ...
                    line.sendMessage(to,"แมวแทน BotSelf")             
#==============================================================================#
                elif "creator" == msg.text.lower():
                    line.sendMessage(to,"CREATOR แมวแทน BotSelf")
                    line.sendContact(to, "")
...
#==============================================================================#
                    ...
                    if targets == []:
                        ...
                        for target in targets:
                            try:
                               ...
                               mi_d = Mids[:33]
                               line.createGroup("แมวแทนBot Self",mi_d)
                               line.sendText(msg.to,"[แมวแทนBot Self]")
                               line.createGroup("แมวแทนBot Self",mi_d)
                               line.sendText(msg.to,"[แมวแทนBot Self]")
                               line.createGroup("แมวแทนBot Self",mi_d)
                               line.sendText(msg.to,"[แมวแทนBot Self]")
                    ...
                    for g in gs.members:
                        ...
                        line.createGroup("🔱แมวแทนBot Self🔱",[key])
                        line.sendText(msg,to,"➠ทำการรัน สำเร็จ")
...
#==============================================================================#
                  ...
                  if msg._from in admin:
                     ...
                     if spl in [""," ","\n",None]:
                         ...
                         line.sendMessage(msg.to, "🔱แมวแทน Bot Self🔱\nตั้งข้อความเมื่อมีคนแอด\n\n{}".format(str(spl)))
...
#==============FINNISHING PROTECT========================#
                ...
                if settings["checkContact"] == True:
                    try:
                        ...
                        ret_ += "\n แมวแทนไอดี : {}".format(str(msg.contentMetadata["mid"]))
        ...
        if op.type == 26:
            ...
            if settings ["Api"] == True:
                if msg.text in ["55","555","5555","55555","55+","555+","5555+","ขำ","ขำๆ"]:
                    line.sendText(msg.to,"แทนว่าไปหาหมอบ้างนะ อิอิ😝😝")
            if settings ["Api"] == True:
